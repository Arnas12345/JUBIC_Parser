...
static const char *const yytname[] =
{
  ...
  "MOVE", "INPUT", "ADD", "TO", "DELIMITER", "EOL", "STRING",
  "IDENTIFIERSIZE", "INTEGER", "IDENTIFIER", "$accept", "sentence",
  "beginning", "declarations", "declaration", "body", "statements",
  "statement", "print", "string", "input", "identifierList", "identifier",
  "move", "moveTo", "add", "addTo", "end", YY_NULL
};
#endif
...
{
      -1,     2,     3,     7,     8,    11,    19,    20,    21,    27,
      22,    32,    33,    23,    30,    24,    36,    38
};
...
/* Line 1792 of yacc.c  */
#line 33 "bison.y"
    {check_unique_identifier((yyvsp[(2) - (3)].chars), (yyvsp[(1) - (3)].integer));}
    break;
...
/* Line 1792 of yacc.c  */
#line 38 "bison.y"
    {check_does_exist((yyvsp[(1) - (3)].chars));}
    break;
...
/* Line 1792 of yacc.c  */
#line 43 "bison.y"
    {moveIntegerTo((yyvsp[(1) - (3)].integer), (yyvsp[(3) - (3)].chars));}
    break;

  case 26:
/* Line 1792 of yacc.c  */
#line 43 "bison.y"
    {moveIdentifierTo((yyvsp[(1) - (3)].chars), (yyvsp[(3) - (3)].chars));}
    break;
